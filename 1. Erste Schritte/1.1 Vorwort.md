## 1.1 Vorwort
> 24.04.26  [Source](https://50ohm.de/N_vorwort.html)

### Mein Vorwort:
```
Ich habe seid den 19.04.26 die Gedanken gehabt, eine Amateurfunk-Lizenz zu machen, damit ich per Radio Morse funken kann. Morse habe ich auch zur diese Zeit entedeckt und fand es sehr spannend.

Diese Datein, sind Notizen die mir und evtl. auch andere helfen für die Klasse N des Amateurfunk-Lizenz zu lernen.

Alle Stoff stammen aus der Kurs: https://50ohm.de/N_course_index.html

Ich hoffe das ich diese Lizens während Uni erwerben kann!
```
...
vy 73 (Viele Grüße) und 55 (Viel Erfolg) wünschen Matthias Jung (DL9MJ) und Björn Swierczek (DL1PZ)
```